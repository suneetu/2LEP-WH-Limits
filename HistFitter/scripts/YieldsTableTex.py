...
\\end{center}
\\caption{Fit results for an integrated luminosity of $20.3$\,\ifb.
The results are obtained using the discovery fit (see text for details). 
...
where the negative error is truncated when reaching to zero event yield. %s
}
